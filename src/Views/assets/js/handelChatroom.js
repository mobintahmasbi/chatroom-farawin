...
let pvListGenerator = (accountContacts) => {
    let newPvBoxDivElem, newImageBoxDivElem, newcircleDiv, newInfoDiw, newTexname, newtexEndChat;
    ...
    accountContacts.forEach((contact) => {
        ...
        newPvBoxDivElem.setAttribute("onclick", `openChatList(${contact.Phone_number})`);
